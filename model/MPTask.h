...
enum {
   ...
   EDIT_BITS_TASKSERIES_NAME     = 1 << 0,
   EDIT_BITS_TASKSERIES_RRULE    = 1 << 1,
   EDIT_BITS_TASKSERIES_LIST     = 1 << 2,
   EDIT_BITS_TASKSERIES_LOCATION = 1 << 3,
   EDIT_BITS_TASKSERIES_TAGS     = 1 << 4
};
