...
@implementation ScaffoldTaskViewController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
   LOG(@"tp tasks count = %d", [tp tasks].count);
   return [tp tasks].count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
   ...
   static NSString *CellIdentifier = @"ScaffoldTaskViewCell";
   ...
   cell.text = [NSString stringWithFormat:@"%d: %@", [task.iD intValue], task.name];
