...
#import "MockTaskProvider.h"

@implementation MockTaskProvider
...
@implementation TaskProvider (Mock)

static MockTaskProvider *s_mock_task_provider = nil;

+ (TaskProvider *) sharedTaskProvider
{
   if (nil == s_mock_task_provider) {
      s_mock_task_provider = [[MockTaskProvider alloc] init];
   }
   return s_mock_task_provider;   
}
